...
import com.oru.iri.*;
import com.oru.iri.conf.Configuration;
import com.oru.iri.controllers.AddressViewModel;
import com.oru.iri.controllers.BundleViewModel;
import com.oru.iri.controllers.TagViewModel;
import com.oru.iri.controllers.TransactionViewModel;
import com.oru.iri.hash.PearlDiver;
import com.oru.iri.network.Neighbor;
import com.oru.iri.network.TCPNeighbor;
import com.oru.iri.network.UDPNeighbor;
...
import com.oru.iri.service.dto.AbstractResponse;
import com.oru.iri.service.dto.AccessLimitedResponse;
import com.oru.iri.service.dto.AddedNeighborsResponse;
import com.oru.iri.service.dto.AttachToTangleResponse;
import com.oru.iri.service.dto.ErrorResponse;
import com.oru.iri.service.dto.ExceptionResponse;
import com.oru.iri.service.dto.FindTransactionsResponse;
import com.oru.iri.service.dto.GetBalancesResponse;
import com.oru.iri.service.dto.GetInclusionStatesResponse;
import com.oru.iri.service.dto.GetNeighborsResponse;
import com.oru.iri.service.dto.GetNodeInfoResponse;
import com.oru.iri.service.dto.GetTipsResponse;
import com.oru.iri.service.dto.GetTransactionsToApproveResponse;
import com.oru.iri.service.dto.GetTrytesResponse;
import com.oru.iri.service.dto.RemoveNeighborsResponse;
import com.oru.iri.utils.Converter;
import com.oru.iri.utils.MapIdentityManager;
...
public class API {
    ...
    private Oru instance;

    public API(Oru instance, IXI ixi) {
        this.instance = instance;
        this.ixi = ixi;
        maxRandomWalks = instance.configuration.integer(Configuration.DefaultConfSettings.MAX_RANDOM_WALKS);
        maxFindTxs = instance.configuration.integer(Configuration.DefaultConfSettings.MAX_FIND_TRANSACTIONS);
        maxGetTrytes = instance.configuration.integer(Configuration.DefaultConfSettings.MAX_GET_TRYTES);
    ...
    private HttpHandler addSecurity(final HttpHandler toWrap) {
        ...
        final List<AuthenticationMechanism> mechanisms = Collections.singletonList(new BasicAuthenticationMechanism("oru Realm"));
