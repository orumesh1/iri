package com.oru.iri.service.dto;
...
public class GetNeighborsResponse extends AbstractResponse {
    ...
    static class Neighbor {
        ...
        public static Neighbor createFrom(com.oru.iri.network.Neighbor n) {
    ...
    public static AbstractResponse create(final List<com.oru.iri.network.Neighbor> elements) {
        GetNeighborsResponse res = new GetNeighborsResponse();
        res.neighbors = new Neighbor[elements.size()];
        int i = 0;
        for (com.oru.iri.network.Neighbor n : elements) {
