...
public class UDPReceiver {
    ...
    private final DatagramPacket receivingPacket = new DatagramPacket(new byte[Node.TRANSACTION_PACKET_SIZE],
            Node.TRANSACTION_PACKET_SIZE);
        ...
        return () -> {
            ...
            while (!shuttingDown.get()) {
                ...
                try {
                    ...
                    if (receivingPacket.getLength() == Node.TRANSACTION_PACKET_SIZE) {
                        ...
                        receivingPacket.setLength(Node.TRANSACTION_PACKET_SIZE);
                    }
